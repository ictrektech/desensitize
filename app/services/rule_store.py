...
BUILTIN_RULES = [
    ...
    },
    {
        ...
        "pattern": r"\b(AKLT[A-Za-z0-9]{18})\b",
    ...
    },
    {
        ...
        "pattern": r"\b(ghp|github_pat)_[A-Za-z0-9]{36,}\b",
    ...
    },
    {
        ...
        "pattern": r"\b(Bearer\s+[A-Za-z0-9_\-\.=]+)\b",
    ...
    },
    {
        ...
        "pattern": r"\b(password|passwd|pwd|secret|token|api[_-]?key|credential)\s*[:=]\s*[\"']?([^\s\"',}]{4,})[\"']?",
